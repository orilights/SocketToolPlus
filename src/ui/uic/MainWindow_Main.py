...
################################################################################
## Form generated from reading UI file 'MainWindow_Main.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_v_localport.setGeometry(QRect(220, 50, 111, 21))
        self.label_v_remoteport = QLabel(self.groupbox_status)
        self.label_v_remoteport.setObjectName(u"label_v_remoteport")
        self.label_v_remoteport.setGeometry(QRect(220, 20, 111, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_v_remoteport.setText(QCoreApplication.translate("MainWindow", u"\u8fdc\u7a0b\u7aef\u53e3\uff1a", None))
