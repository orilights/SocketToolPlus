...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_socket_send.setToolTip(QCoreApplication.translate("MainWindow", u"\u5c06\u53d1\u9001\u6846\u7684\u4fe1\u606f\u53d1\u9001\u5230\u8fdc\u7a0b\u5730\u5740", None))
#endif // QT_CONFIG(tooltip)
        self.btn_socket_send.setText(QCoreApplication.translate("MainWindow", u"\u53d1\u9001", None))
#if QT_CONFIG(tooltip)
        self.btn_template_save.setToolTip(QCoreApplication.translate("MainWindow", u"\u4fdd\u5b58\u3001\u7ba1\u7406\u53d1\u9001\u6a21\u677f", None))
#endif // QT_CONFIG(tooltip)
        self.btn_template_save.setText(QCoreApplication.translate("MainWindow", u"\u4fdd\u5b58\u6a21\u677f", None))
#if QT_CONFIG(tooltip)
        self.btn_template_read.setToolTip(QCoreApplication.translate("MainWindow", u"\u8bfb\u53d6\u3001\u7ba1\u7406\u53d1\u9001\u6a21\u677f", None))
#endif // QT_CONFIG(tooltip)
        self.btn_template_read.setText(QCoreApplication.translate("MainWindow", u"\u8bfb\u53d6\u6a21\u677f", None))
#if QT_CONFIG(tooltip)
        self.btn_sendclear.setToolTip(QCoreApplication.translate("MainWindow", u"\u6e05\u9664\u53d1\u9001\u6846\u7684\u5185\u5bb9", None))
#endif // QT_CONFIG(tooltip)
        self.btn_sendclear.setText(QCoreApplication.translate("MainWindow", u"\u6e05\u9664", None))
#if QT_CONFIG(tooltip)
        self.btn_text_format.setToolTip(QCoreApplication.translate("MainWindow", u"\u683c\u5f0f\u5316JSON\u683c\u5f0f\u7684\u6587\u672c", None))
#endif // QT_CONFIG(tooltip)
